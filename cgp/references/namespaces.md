...
A namespace is a reusable, named lookup table of component wirings that a context inherits wholesale and then selectively overrides. It is CGP's preset mechanism, expressed entirely at the type level with no runtime cost.
